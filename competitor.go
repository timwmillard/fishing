...
type CompetitorRepo interface {
	...
	Create(ctx context.Context, c CompetitorParams) (Competitor, error)
	Update(ctx context.Context, id HashID, c CompetitorParams) (Competitor, error)
